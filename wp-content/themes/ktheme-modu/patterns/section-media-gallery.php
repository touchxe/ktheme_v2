...
$ktheme_modu_gallery_images = array(
...
<div class="wp-block-group alignwide kt-section kt-section--media-gallery">
	...
	<div class="wp-block-group kt-section__header">
		...
		<p class="kt-card-label"><?php echo esc_html__( 'Community Gallery', 'ktheme-modu' ); ?></p>
		<!-- /wp:paragraph -->
		<!-- wp:heading {"level":2} -->
		<h2 class="wp-block-heading"><?php echo esc_html__( '함께한 순간을 소개합니다', 'ktheme-modu' ); ?></h2>
		<!-- /wp:heading -->
		<!-- wp:paragraph -->
		<p><?php echo esc_html__( '사진과 설명은 사이트 편집기에서 각 공동체와 사역에 맞게 교체할 수 있습니다.', 'ktheme-modu' ); ?></p>
		<!-- /wp:paragraph -->
	</div>
	<!-- /wp:group -->
	...
	<figure class="wp-block-gallery alignwide has-nested-images columns-3 is-cropped kt-media-gallery">
		...
		<figure class="wp-block-image size-large"><img src="<?php echo esc_url( $ktheme_modu_gallery_images[0] ); ?>" alt="<?php echo esc_attr__( '예배와 공동체가 함께하는 모습', 'ktheme-modu' ); ?>" /></figure>
		<!-- /wp:image -->
		<!-- wp:image {"sizeSlug":"large","linkDestination":"none"} -->
		<figure class="wp-block-image size-large"><img src="<?php echo esc_url( $ktheme_modu_gallery_images[1] ); ?>" alt="<?php echo esc_attr__( '말씀을 나누는 공동체 모임', 'ktheme-modu' ); ?>" /></figure>
		<!-- /wp:image -->
		<!-- wp:image {"sizeSlug":"large","linkDestination":"none"} -->
		<figure class="wp-block-image size-large"><img src="<?php echo esc_url( $ktheme_modu_gallery_images[2] ); ?>" alt="<?php echo esc_attr__( '교제와 섬김이 이어지는 모습', 'ktheme-modu' ); ?>" /></figure>
		<!-- /wp:image -->
	</figure>
	<!-- /wp:gallery -->
</div>
