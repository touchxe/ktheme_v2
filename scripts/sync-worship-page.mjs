...
const content = `<!-- wp:group {"className":"kt-worship-content","layout":{"type":"constrained"}} -->
<div class="wp-block-group kt-worship-content">
<!-- wp:html -->
<section class="kt-worship-band">
  <div class="kt-label">Worship at Gapyeong</div>
  ...
  <div class="kt-worship-schedule">
    <a class="kt-worship-time" href="/sunday-worship/"><strong>Sunday</strong><h3>주일예배</h3><p>오전 11:00 · 본당<br />온 가족이 함께 드리는 중심 예배</p></a>
    <a class="kt-worship-time" href="/wednesday-worship/"><strong>Wednesday</strong><h3>수요예배</h3><p>오후 7:30 · 본당<br />말씀과 기도로 한 주를 세우는 예배</p></a>
    <a class="kt-worship-time" href="/dawn-prayer/"><strong>Weekday</strong><h3>새벽예배</h3><p>월-금 오전 5:30<br />하루를 말씀과 기도로 여는 시간</p></a>
    <a class="kt-worship-time" href="/youth-worship/"><strong>Youth</strong><h3>청년예배</h3><p>주일 오후 2:00<br />청년 공동체의 찬양과 말씀</p></a>
  </div>
</section>

<section class="kt-worship-section kt-worship-two-col">
  <div>
    <div class="kt-label">For First Visit</div>
    <h2>처음 오셔도 괜찮습니다.</h2>
    <p>예배가 익숙하지 않은 분도 편안하게 참여할 수 있도록 로비 안내 데스크에서 좌석, 자녀 예배, 주차, 새가족 등록을 도와드립니다.</p>
    <a class="kt-button kt-button--dark" href="/newcomers/">새가족 안내 보기</a>
  </div>
  <ul class="kt-worship-list">
...
<section class="kt-worship-section kt-worship-two-col">
  <div>
    <div class="kt-label">Online Worship</div>
...
<section class="kt-worship-cta">
  <div>
    <h2>예배에 함께하고 싶으신가요?</h2>
    <p>방문 전 궁금한 점이 있다면 사역자가 안내해 드립니다.</p>
  </div>
  <div class="kt-buttons">
    <a class="kt-button kt-button--light" href="/location/">오시는 길</a>
    <a class="kt-button kt-button--ghost" href="/contact/">문의하기</a>
  </div>
</section>
<!-- /wp:html -->
</div>
